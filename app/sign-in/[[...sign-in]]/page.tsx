  ...
  return (
    <main style={{
      ...
      <style>{`
        ...
        .cl-rootBox { font-family: 'IBM Plex Sans', sans-serif; }
        ...
        .cl-formButtonPrimary { background: #FF6B00 !important; border-radius: 2px !important; font-family: 'IBM Plex Sans', sans-serif !important; letter-spacing: 0.1em !important; box-shadow: none !important; }
        .cl-footerActionLink { color: #FF6B00 !important; }
        .cl-identityPreviewText { color: #ebebeb !important; }
